...
public enum BotMessages {
	...
	HELLO_MYTODO_BOT("Hello! I'm ChocoBot!\nType a new todo ChocoItem below and press the send button (blue arrow), or select an option below:"),
	...
	ITEM_EDIT("Edit task"), 
	STORYPOINTS("How many storypoints?"),
	RESPONSABLE("Who is assigned?"),
